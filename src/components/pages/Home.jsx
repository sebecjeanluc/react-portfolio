    ...
    <section id="home">
      <div className="home__wrapper">
        <div className="home_profile_pic--wrapper">
          <img src="/react-portfolio/src/assets/images/pf_pic_BL.jpg" alt="Tak profile picture"/>
        </div>
        <div className="home_title--wrapper">
          ...
          <div className="contact-button__wrapper">
            <a href="/react-portfolio/src/assets/pdf/TakuyKawamuraResume2023EN-technicalResume.pdf" download>
